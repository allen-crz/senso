...
import { Droplet, TrendingUp, Brain, Clock, Activity, CheckCircle, AlertCircle } from 'lucide-react';
import { Card, CardContent, CardHeader, CardTitle } from '@/components/ui/card';
import { Skeleton } from '@/components/ui/skeleton';
import { useMonthlyForecast, useModelInfo, useForecastComparison, useForecastAccuracy } from '@/hooks/useCostForecasting';
...
const SimplifiedWaterForecast: React.FC = () => {
  ...
  const { data: comparison } = useForecastComparison('water', 1);
        ...
        <div className="space-y-2">
          {hasCycleData && (
            <div className="flex justify-between text-sm">
              ...
              <span className="font-semibold">{cycleData.daily_average?.toFixed(2) || '0.00'} m³/day</span>
            </div>
          )}
          {paceVsForecast !== null && (
            <div className="flex justify-between text-sm">
        ...
        {comparison && comparison.comparisons && comparison.comparisons[0] && comparison.comparisons[0].actual_cost && (
          <div className="bg-gradient-to-r from-purple-50 to-blue-50 p-4 rounded-lg border border-purple-100">
            <div className="flex items-center justify-between mb-3">
              <h4 className="text-sm font-semibold text-purple-900">Last Month Accuracy</h4>
